...
type DummyServiceClient interface {
	Hello(ctx context.Context, in *DummyRequest, opts ...grpc.CallOption) (*DummyResponse, error)
}
...
func (c *dummyServiceClient) Hello(ctx context.Context, in *DummyRequest, opts ...grpc.CallOption) (*DummyResponse, error) {
...
type DummyServiceServer interface {
	Hello(context.Context, *DummyRequest) (*DummyResponse, error)
...
func (UnimplementedDummyServiceServer) Hello(context.Context, *DummyRequest) (*DummyResponse, error) {
...
func _DummyService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DummyServiceServer).Hello(ctx, req.(*DummyRequest))
	}
